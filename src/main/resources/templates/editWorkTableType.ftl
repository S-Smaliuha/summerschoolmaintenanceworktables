    ...
    <fieldset>
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="country" value="${item.country}"><br></td>
            </tr>
            <tr>
                <td><label for="name">Issuance year:</label></td>
                <td><input type="text" name="issuanceYear" value="${item.issuanceYear}"><br></td>
            </tr>
            <tr>
                <td></td>
                <td>
